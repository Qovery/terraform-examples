...
This ready to use example shows you how to deploy a lifecycle job from GitHub (and from an image) on AWS. All of that in just a few lines of Terraform file.
