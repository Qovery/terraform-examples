...
This ready to use example shows you how to deploy a containerized app (Strapi) with PostgreSQL on AWS in Production, Staging and Dev and make it accessible via HTTPS. All of that in just a few lines of Terraform file.
...
8. Generates a TLS certificate for all your apps
...
⚠️ Make sure you have [increased your AWS VPC Quota](https://docs.aws.amazon.com/vpc/latest/userguide/amazon-vpc-limits.html) to at least 20. Otherwise, you will risk having failed cluster deployments since every cluster runs on a dedicated VPC.
