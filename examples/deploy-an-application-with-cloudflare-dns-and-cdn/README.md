...
This ready to use example shows you how to deploy an application from GitHub on AWS and make it accessible via a custom domain and HTTPS. All of that in just a few lines of Terraform file.
